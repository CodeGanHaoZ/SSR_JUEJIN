...
`, J = "", u = t.forwardRef(
  ({
    ...
    const O = X(D), p = x || Y(), s = g(new T(p, { style: "decimal" })), c = g(new z(p, { maximumFractionDigits: 20 })), [a, S] = G({
      prop(e) {
        const o = String(k);
      ...
      const e = s.current.parse(a), o = isNaN(e) ? i : e + i;
      ...
      if (a) {
        const e = s.current.parse(a), o = isNaN(e) ? "" : c.current.format(e);
        l(o);
      }
    };
