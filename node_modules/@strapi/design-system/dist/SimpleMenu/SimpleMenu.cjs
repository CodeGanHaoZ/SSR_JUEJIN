"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const a=require("react"),z=require("prop-types"),U=require("styled-components"),H=require("react-router-dom"),M=require("@radix-ui/react-use-callback-ref"),G=require("@strapi/icons"),T=require("../Typography/Typography.cjs"),J=require("../Link/Link.cjs"),b=require("../Box/Box.cjs"),Q=require("../Flex/Flex.cjs"),j=require("../Button/Button.cjs"),w=require("../Popover/Popover.cjs"),q=require("./utils.cjs"),X=require("../helpers/useId.cjs"),s=require("../helpers/keyboardKeys.cjs"),B=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},o=B(a),t=B(z),E=B(U),Y=E.default.button`
  border: none;
  padding: 0;
