"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const a=require("react"),z=require("prop-types"),U=require("styled-components"),D=require("@radix-ui/react-use-callback-ref"),H=require("@strapi/icons"),G=require("../Link/Link.cjs"),C=require("../../Typography/Typography.cjs"),k=require("../../Box/Box.cjs"),J=require("../../Flex/Flex.cjs"),M=require("../../Button/Button.cjs"),Q=require("../../BaseLink/BaseLink.cjs"),j=require("../../Popover/Popover.cjs"),T=require("./utils.cjs"),X=require("../../helpers/useId.cjs"),u=require("../../helpers/keyboardKeys.cjs"),q=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},o=q(a),t=q(z),y=q(U),Y=y.default.button`
  border: none;
  padding: 0;
  background: transparent;
  cursor: pointer;
  ${T.getOptionStyle}
`,Z=y.default(Q.BaseLink)`
