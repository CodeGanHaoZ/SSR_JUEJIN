...
import { BaseLink as J } from "../../BaseLink/BaseLink.js";
...
`, $ = ({ as: o, children: l, onClick: d, isFocused: c, isLink: k, isExternal: v, ...C }) => {
  ...
  return k ? /* @__PURE__ */ t.createElement(ee, {
    as: o,
    ...i
  }, /* @__PURE__ */ t.createElement(g, {
    padding: 2
  }, /* @__PURE__ */ t.createElement(O, null, l))) : v ? /* @__PURE__ */ t.createElement(ne, {
    isExternal: !0,
    ...i
  }, /* @__PURE__ */ t.createElement(g, {
    padding: 2
  }, /* @__PURE__ */ t.createElement(O, null, l))) : /* @__PURE__ */ t.createElement(Z, {
    onKeyDown: x,
    onMouseDown: d,
    type: "button",
    ...i
    ...
    padding: 2
  }, /* @__PURE__ */ t.createElement(O, null, l)));
};
$.defaultProps = {
  as: void 0,
  onClick() {
...
const h = ({
  ...
  const s = b(), P = Y(d), R = b(!1), [u, f] = B(!1), [D, I] = B(0), y = z.toArray(l), A = c || (C === "S" ? oe : K), S = !!i && typeof i == "function";
  E(() => {
  ...
  const N = (n) => {
    ...
    S && i();
  }, _ = y.map((n, r) => /* @__PURE__ */ t.createElement(G, {
    as: "li",
    key: r,
  ...
  return /* @__PURE__ */ t.createElement("div", {
    ...
    type: "button",
    variant: "ghost",
    endIcon: /* @__PURE__ */ t.createElement(te, null, /* @__PURE__ */ t.createElement(H, {
      "aria-hidden": !0
    })),
    ...x
  }, o), u && /* @__PURE__ */ t.createElement(X, {
    onBlur: V,
    placement: p,
    source: s,
    onReachEnd: W,
