import r, { useState as ee, useRef as te, Children as k, cloneElement as j } from "react";
...
`, z = ({
  ...
  const n = fe(H), [h, E] = ee(void 0), $ = ye(h), R = te(null), w = `${n}-label`, b = `${n}-content`, X = typeof m == "string";
  let B;
  ...
  const M = (t, l) => {
    ...
    return c && (u ? F.push({ label: t.props.children, value: t.props.value }) : T = t.props.children), j(t, {
      id: q(a),
    ...
    if (t.type.displayName === "OptGroup") {
      ...
      return j(t, {
        ...
        indeterminate: c,
        multi: i,
        children: k.toArray(t.props.children).map((p) => M(p, !0)),
        value: t.props.label
      });
    }
    return M(t);
  ...
  return /* @__PURE__ */ r.createElement(se, {
    ...
    spacing: d || v || X ? 1 : 0
  }, d && /* @__PURE__ */ r.createElement(ae, {
    action: G
  }, d), /* @__PURE__ */ r.createElement(he, {
    size: Q,
    hasError: Boolean(m),
    disabled: s,
    ref: R
  ...
  }, /* @__PURE__ */ r.createElement(C, null, x && /* @__PURE__ */ r.createElement(P, {
    paddingLeft: 3,
    "aria-hidden": !0
    ...
    paddingLeft: 4,
    paddingRight: 4
  }, u ? /* @__PURE__ */ r.createElement(r.Fragment, null, !o || o.length === 0 ? /* @__PURE__ */ r.createElement(A, {
    ellipsis: !0,
    id: b,
    textColor: "neutral600"
  }, y) : null, /* @__PURE__ */ r.createElement(_, {
    as: "span",
    id: b
  }, f ? f(o) : T || y, o.join(", "))) : /* @__PURE__ */ r.createElement(A, {
    ellipsis: !0,
    id: b,
    textColor: o ? "neutral800" : "neutral600"
  }, f ? f(o) : T || y, i && /* @__PURE__ */ r.createElement(_, {
    as: "span"
