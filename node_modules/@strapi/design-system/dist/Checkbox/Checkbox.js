...
import { useId as g } from "../helpers/useId.js";
...
}, a = ({ children: o, disabled: t, id: p, hint: m, error: l, ...d }) => {
  const i = g(p);
  let n;
  return l ? n = `${i}-error` : m && (n = `${i}-hint`), /* @__PURE__ */ r.createElement(u, {
    id: i,
    hint: m,
    error: l
    ...
    paddingLeft: 2
  }, o)), /* @__PURE__ */ r.createElement(b, null), /* @__PURE__ */ r.createElement(y, null)));
};
a.defaultProps = {
  disabled: !1,
  id: void 0,
