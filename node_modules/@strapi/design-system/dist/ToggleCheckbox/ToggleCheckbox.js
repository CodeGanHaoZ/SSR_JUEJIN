...
import { sizes as E } from "../themes/sizes.js";
...
import { useField as z } from "../Field/FieldContext.js";
...
`, s = t.forwardRef(
  ({ size: e, onLabel: a, offLabel: i, children: g, checked: r, disabled: o, onChange: h, ...b }, x) => {
    const { error: y, hint: C, id: d, name: w, required: v } = z(), f = "neutral600";
    let $ = !r && r !== null ? "danger700" : f, k = r ? "primary600" : f;
    const R = (u) => {
      o || h(u);
    };
    let p;
    return y ? p = `${d}-error` : C && (p = `${d}-hint`), /* @__PURE__ */ t.createElement(S, null, /* @__PURE__ */ t.createElement(L, null, g), /* @__PURE__ */ t.createElement(j, {
      hasRadius: !0,
      disabled: o,
      padding: 1,
      display: "flex",
...
s.propTypes = {
  ...
  size: n.oneOf(Object.keys(E.input))
};
export {
  s as ToggleCheckbox
};
